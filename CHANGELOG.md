...
- `identity/ldap/bootstrap.yaml`: replace SSHA hashes in `06-sample-users.ldif` with known-password hashes; add comment documenting dev credentials (`admin/Shopping1!`, `developer/Dev1234!`, `operator/Ops5678!`)
