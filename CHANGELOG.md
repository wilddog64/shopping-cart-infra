...
### Fixed
- `data-layer/minio/`: repoint MinIO and `mc` from the quay.io registry after its repository-level gate began requiring authentication for anonymous pulls; use `docker.io/bitnamilegacy/minio:2024.11.7-debian-12-r1` and `docker.io/bitnamilegacy/minio-client:2024.11.5-debian-12-r1` instead.
